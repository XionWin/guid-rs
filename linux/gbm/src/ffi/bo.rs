...
extern "C" {
    pub fn gbm_bo_create(handle: *const crate::ffi::GbmDevice, width: libc::c_uint, height: libc::c_uint, format: crate::ffi::def::SurfaceFormat, flags: crate::ffi::def::SurfaceFlags) -> *const GbmBufferObject;
